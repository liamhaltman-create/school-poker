      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-gray-900 rounded-2xl p-8 border border-gray-800">
          ...
          <form onSubmit={handleLogin} className="space-y-4">
            ...
            <input type="password" value={password} onChange={e => setPassword(e.target.value)} required placeholder="Password" className="w-full bg-gray-800 border border-gray-700 rounded-lg px-3 py-2.5 text-white text-sm" />
          ...
          <p className="text-center text-gray-500 text-sm mt-6">No account? <Link href="/auth/register" className="text-green-400">Create one</Link></p>
        </div>
      </div>
    </div>
  )
